    ...
    return (
        <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center bg-black border-b border-white/10">
            ...
            <div className="absolute inset-0 z-0">
                <AnimatedShader className="opacity-40 mix-blend-screen" />
            </div>
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
                <div className="relative w-full h-full animate-breath mix-blend-overlay">
                    <Image
            ...
            <div className="relative z-10 container mx-auto px-4 text-center">
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm md:text-lg text-white/60 font-mono tracking-[0.3em] uppercase opacity-0 animate-fade-in-up" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
