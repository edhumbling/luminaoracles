...
export const TESTIMONIALS = [
    ...
    {
        name: "Mamahil",
        text: "Great Goddess the true Goddess of our time, the revealer, the revelation in human form, the history maker, you unveil hidden secrets, your words commands listening and serious minds always absorb wisdom from you. INDEED YOU ARE THE QUANTUM MOUTHPIECE OF THE AIRWAVES 🥰🥰🥰"
    },
    {
        name: "Mayiba",
