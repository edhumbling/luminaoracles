...
void main(){gl_Position=position;}`;
  ...
  render(now = 0) {
    ...
    if (!program || gl.getProgramParameter(program, gl.DELETE_STATUS) || !this.uniformLocations) return;
...
const useShaderBackground = () => {
  ...
  const resize = () => {
    ...
    // Check if parent has dimensions, otherwise fallback
...
// Standalone AnimatedShader component for cards
